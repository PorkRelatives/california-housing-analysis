...
plt.title("Average Occupancy (<=30) vs. Median House Value with Regression Line")
...
# Save the plot
plt.savefig("occupancy_price_regression_filtered.png")

print("Filtered regression plot with stats saved as occupancy_price_regression_filtered.png")
