...
# Set title
ax.set_title('Los Angeles Metropolitan Area Housing Prices with Basemap')

# Save the figure
plt.savefig("la_metro_area_with_basemap.png", dpi=300)

print("LA Metro Area map with basemap saved as la_metro_area_with_basemap.png")
