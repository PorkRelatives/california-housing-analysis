...
# Filter out outliers where AveOccup is greater than 10
...
plt.title("Average Occupancy (<=10) vs. Median House Value with Regression Line")
...
# Save the plot
plt.savefig("occupancy_price_regression_filtered_10.png")

print("Filtered regression plot with stats saved as occupancy_price_regression_filtered_10.png")
