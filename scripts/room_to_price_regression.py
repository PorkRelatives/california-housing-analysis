...
# Filter the data
housing_filtered = housing[housing["AveRooms"] < 30]

# Prepare the data for regression
X = housing_filtered[["AveRooms"]]
...
plt.title("Relationship between Average Rooms and Median House Value (AveRooms < 30)")
...
# Save the figure
plt.savefig("room_to_price_regression.png")

print("Regression analysis plot saved as room_to_price_regression.png")
